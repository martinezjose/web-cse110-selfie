...
/*
		setInterval(function() {
			...
			var myNode = document.getElementById("pings");
			...
			if(pings){
				...
				if(pings.length == 0)
				{
$( "#pings" ).append( "<li class='list-group-item'><label class='label-checkbox inline'></label>No pings yet</span></li>" );

				}
				for (var i = 0; i < pings.length; i++) {
$( "#pings" ).append( "<li class='list-group-item pull-left'><label class='label-checkbox inline'>");


										 if (pings[i].StatusID == 3 || pings[i].StatusID == 1){
$( "#pings" ).append( "<input id='chk'"+pings[i].PingID+" type='checkbox' class='task-finish' checked>");
									}else{

$( "#pings" ).append( "<input id='chk'"+pings[i].PingID+" type='checkbox' class='task-finish' >");
}

$( "#pings" ).append( "");
$( "#pings" ).append( "<span class='custom-checkbox'></span></label>");


									if (pings[i].StatusID == 2 || pings[i].StatusID == 3){

$( "#pings" ).append( "Order ready for table");


									}
									else
									{
										$( "#pings" ).append( "Service request from table");
